...
public class PluginItemGroups{
	...
	public static final NestedItemGroup PLUGIN_NESTED = new NestedItemGroup(SlimePlugin.key("PLUGIN_NESTED"),
			new CustomItem(Heads.EXAMPLE_NESTED.item(), Utils.PREFIX));

	// Sub Item Groups
	public static final SubItemGroup PLUGIN_SUB = new SubItemGroup(SlimePlugin.key("PLUGIN_SUB"), PLUGIN_NESTED,
